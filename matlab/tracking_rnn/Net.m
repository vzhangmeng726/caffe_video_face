classdef Net < handle
  ...
  methods
    ...
    %
    function backward_fromto(self,s,e)
      caffe_('net_backwardfromto', self.hNet_self,s,e);
    end
    function forward_fromto(self,s,e)
      caffe_('net_forwardfromto', self.hNet_self,s,e);
    end
